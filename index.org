...
#+begin_src conf
  ...
  exec-once = gsettings set org.gnome.desktop.interface gtk-theme Adapta-Nord
...
#+begin_src conf
  $terminal = alacritty
  $fileManager = thunar
  $menu = wofi -c ~/.config/wofi/config -s ~/.config/wofi/style.css --show drun
...
** =~/.config/hypr/hypr.d/ecosystem.conf=
:PROPERTIES:
...
#+end_src
** =~/.config/hypr/hypr.d/cursor.conf=
:PROPERTIES:
...
#+begin_src conf
  ...
  bind = $mainMod, Q, exec, wofi-power-menu --config ~/.config/wofi-power-menu.toml
  ...
  bind = $mainMod, W, exec, ~/.local/bin/hyprland-wofi-windowcd
  bind = $mainMod, S, exec, ~/.local/bin/browser-search
...
#+begin_src conf
  ...
  bind = $mainMod Alt, k, togglespecialworkspace, khal
